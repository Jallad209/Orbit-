...
|   2 | Foreign `orbit://` handler survives install and Orbit reports that it is not owner                            | FAIL (installer PASS, app status missing) | `foreign-handler-before-install.json`, registry export, Settings screenshot |
