...
| Installed Windows       | PARTIAL PASS | Sandbox pass 19 Sep on alpha.2: scenarios 1, 3–11 PASS; 2 FAIL (installer OK, app shows no handler status — fix pending); host-account 12–14 NOT RUN; evidence in installed/                                                                |
...
| Installed desktop, Sandbox (scenarios 1–11)  | 10 PASS, 1 FAIL — scenario 2b, the app shows no handler status (19 September)                                                                    |
| Host account (12–14), manual a11y, net-watch | NOT RUN                                                                                                                                          |
