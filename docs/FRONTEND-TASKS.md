...
## Week 2: Base Component Library & PWA Shell
...
- [ ] `apps/orbit/src/components/ui/*` (≥ 18 components)
- [ ] `apps/orbit/src/styles/motion.ts`
- [ ] `apps/orbit/public/manifest.webmanifest`, service worker config
...
| **Week 2**  | Base Component Library & PWA Shell            | ⏳ PENDING  | 0%       |
